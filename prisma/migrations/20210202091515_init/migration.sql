/*
  ...
  - The migration will remove the values [React_Grid_ResponsiveContainer,React_Grid_Container,React_Grid_Item] on the enum `VertexType`. If these variants are still used in the database, the migration will fail.
