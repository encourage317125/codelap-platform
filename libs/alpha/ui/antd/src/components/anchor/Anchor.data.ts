...
export const anchorData: NodeI = {
  type: AtomType.ReactHtmlDiv,
  children: [
    {
      type: AtomType.ReactAnchor,
      props: {},
      children: [
        {
          type: AtomType.ReactAnchorLink,
          props: {
            href: '#1',
            title: '1',
          },
      ...
      children: [
        {
          ...
          children: [{ type: AtomType.ReactText, props: { value: '1' } }],
        },
        {
      ...
      children: [
        {
          type: AtomType.ReactHtmlDiv,
          props: { style: { fontSize: 30, fontWeight: 'bold' } },
          children: [{ type: AtomType.ReactText, props: { value: '2' } }],
        },
        {
          type: AtomType.ReactHtmlP,
          children: [
      ...
      children: [
        {
          type: AtomType.ReactHtmlDiv,
          props: { style: { fontSize: 30, fontWeight: 'bold' } },
          children: [{ type: AtomType.ReactText, props: { value: '3' } }],
        },
        {
          type: AtomType.ReactHtmlP,
          children: [
