...
/**
 * A mapping of VertexTypes to their corresponding React components.
 * Returns null if a mapping is not found
 *
 * When adding new Atom types, add the corresponding mapping here
 */
// Implemented as a switch statement instead of a map, since otherwise they would all get loaded into memory
export const atomTypeElementFactory = (
  atomType: AtomType,
