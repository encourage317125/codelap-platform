...
export const ResetDataGql = gql`
  ...
  resetData
    ...
    `;
export type ResetDataMutationFn = Apollo.MutationFunction<ResetDataMutation, ResetDataMutationVariables>;
 ...
 * });
 */
export function useResetDataMutation(baseOptions?: Apollo.MutationHookOptions<ResetDataMutation, ResetDataMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ResetDataMutation, ResetDataMutationVariables>(ResetDataGql, options);
      }
...
export type ResetDataMutationOptions = Apollo.BaseMutationOptions<ResetDataMutation, ResetDataMutationVariables>;