...
export type GetTypeKindsQuery = { getTypes: Array<{ __typename: 'ArrayType', id: string, typeKind: Types.TypeKind } | { __typename: 'ComponentType', id: string, typeKind: Types.TypeKind } | { __typename: 'ElementType', id: string, typeKind: Types.TypeKind } | { __typename: 'EnumType', id: string, typeKind: Types.TypeKind } | { __typename: 'InterfaceType', id: string, typeKind: Types.TypeKind } | { __typename: 'LambdaType', id: string, typeKind: Types.TypeKind } | { __typename: 'PrimitiveType', id: string, typeKind: Types.TypeKind } | { __typename: 'ReactNodeType', id: string, typeKind: Types.TypeKind } | { __typename: 'RenderPropsType', id: string, typeKind: Types.TypeKind }> };
