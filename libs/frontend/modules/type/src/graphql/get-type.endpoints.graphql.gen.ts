...
export type GetTypesQuery = { primitiveTypes: Array<Type_PrimitiveType_Fragment>, arrayTypes: Array<Type_ArrayType_Fragment>, unionTypes: Array<Type_UnionType_Fragment>, interfaceTypes: Array<Type_InterfaceType_Fragment>, elementTypes: Array<Type_ElementType_Fragment>, renderPropsTypes: Array<Type_RenderPropsType_Fragment>, reactNodeTypes: Array<Type_ReactNodeType_Fragment>, enumTypes: Array<Type_EnumType_Fragment>, lambdaTypes: Array<Type_LambdaType_Fragment>, pageTypes: Array<Type_PageType_Fragment>, appTypes: Array<Type_AppType_Fragment>, actionTypes: Array<Type_ActionType_Fragment>, codeMirrorTypes: Array<Type_CodeMirrorType_Fragment> };
...
export type GetRenderPropsTypesQuery = { types: Array<Type_RenderPropsType_Fragment> };
...
export const GetRenderPropsTypesDocument = gql`
    query GetRenderPropsTypes($options: RenderPropsTypeOptions, $where: RenderPropsTypeWhere) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetTypes(variables?: GetTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetTypesQuery>(GetTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetTypes', 'query');
    },
    GetDescendants(variables?: GetDescendantsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetDescendantsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetDescendantsQuery>(GetDescendantsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetDescendants', 'query');
    },
    GetPrimitiveTypes(variables?: GetPrimitiveTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetPrimitiveTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPrimitiveTypesQuery>(GetPrimitiveTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetPrimitiveTypes', 'query');
    },
    GetArrayTypes(variables?: GetArrayTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetArrayTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetArrayTypesQuery>(GetArrayTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetArrayTypes', 'query');
    },
    GetUnionTypes(variables?: GetUnionTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetUnionTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetUnionTypesQuery>(GetUnionTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetUnionTypes', 'query');
    },
    GetInterfaceTypes(variables?: GetInterfaceTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetInterfaceTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetInterfaceTypesQuery>(GetInterfaceTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetInterfaceTypes', 'query');
    },
    GetElementTypes(variables?: GetElementTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetElementTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetElementTypesQuery>(GetElementTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetElementTypes', 'query');
    },
    GetRenderPropsTypes(variables?: GetRenderPropsTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetRenderPropsTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRenderPropsTypesQuery>(GetRenderPropsTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetRenderPropsTypes', 'query');
    },
    GetReactNodeTypes(variables?: GetReactNodeTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetReactNodeTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetReactNodeTypesQuery>(GetReactNodeTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetReactNodeTypes', 'query');
    },
    GetEnumTypes(variables?: GetEnumTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetEnumTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetEnumTypesQuery>(GetEnumTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetEnumTypes', 'query');
    },
    GetLambdaTypes(variables?: GetLambdaTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetLambdaTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetLambdaTypesQuery>(GetLambdaTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetLambdaTypes', 'query');
    },
    GetPageTypes(variables?: GetPageTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetPageTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPageTypesQuery>(GetPageTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetPageTypes', 'query');
    },
    GetAppTypes(variables?: GetAppTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetAppTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetAppTypesQuery>(GetAppTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetAppTypes', 'query');
    },
    GetActionTypes(variables?: GetActionTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetActionTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetActionTypesQuery>(GetActionTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetActionTypes', 'query');
    },
    GetCodeMirrorTypes(variables?: GetCodeMirrorTypesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetCodeMirrorTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetCodeMirrorTypesQuery>(GetCodeMirrorTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetCodeMirrorTypes', 'query');
    }
  };
}
