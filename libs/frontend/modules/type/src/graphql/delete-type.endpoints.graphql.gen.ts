...
export type DeleteRenderPropsTypesMutation = { deleteRenderPropsTypes: { relationshipsDeleted: number, nodesDeleted: number } };
...
export const DeleteRenderPropsTypesDocument = gql`
    mutation DeleteRenderPropsTypes($delete: RenderPropsTypeDeleteInput, $where: RenderPropsTypeWhere) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    DeletePrimitiveTypes(variables?: DeletePrimitiveTypesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeletePrimitiveTypesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeletePrimitiveTypesMutation>(DeletePrimitiveTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeletePrimitiveTypes', 'mutation');
    },
    DeleteArrayTypes(variables?: DeleteArrayTypesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteArrayTypesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteArrayTypesMutation>(DeleteArrayTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteArrayTypes', 'mutation');
    },
    DeleteReactNodeTypes(variables?: DeleteReactNodeTypesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteReactNodeTypesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteReactNodeTypesMutation>(DeleteReactNodeTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteReactNodeTypes', 'mutation');
    },
    DeleteUnionTypes(variables?: DeleteUnionTypesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteUnionTypesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteUnionTypesMutation>(DeleteUnionTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteUnionTypes', 'mutation');
    },
    DeleteInterfaceTypes(variables?: DeleteInterfaceTypesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteInterfaceTypesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteInterfaceTypesMutation>(DeleteInterfaceTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteInterfaceTypes', 'mutation');
    },
    DeleteElementTypes(variables?: DeleteElementTypesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteElementTypesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteElementTypesMutation>(DeleteElementTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteElementTypes', 'mutation');
    },
    DeleteRenderPropsTypes(variables?: DeleteRenderPropsTypesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteRenderPropsTypesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteRenderPropsTypesMutation>(DeleteRenderPropsTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteRenderPropsTypes', 'mutation');
    },
    DeleteEnumTypes(variables?: DeleteEnumTypesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteEnumTypesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteEnumTypesMutation>(DeleteEnumTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteEnumTypes', 'mutation');
    },
    DeleteLambdaTypes(variables?: DeleteLambdaTypesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteLambdaTypesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteLambdaTypesMutation>(DeleteLambdaTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteLambdaTypes', 'mutation');
    },
    DeletePageTypes(variables?: DeletePageTypesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeletePageTypesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeletePageTypesMutation>(DeletePageTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeletePageTypes', 'mutation');
    },
    DeleteAppTypes(variables?: DeleteAppTypesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteAppTypesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteAppTypesMutation>(DeleteAppTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteAppTypes', 'mutation');
    },
    DeleteActionTypes(variables?: DeleteActionTypesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteActionTypesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteActionTypesMutation>(DeleteActionTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteActionTypes', 'mutation');
    },
    DeleteCodeMirrorTypes(variables?: DeleteCodeMirrorTypesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteCodeMirrorTypesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteCodeMirrorTypesMutation>(DeleteCodeMirrorTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteCodeMirrorTypes', 'mutation');
    }
  };
}
