...
export type DeleteFieldMutation = { updateInterfaceTypes: { interfaceTypes: Array<InterfaceTypeFragment> } };


export const UpsertFieldDocument = gql`
    mutation UpsertField($interfaceTypeId: ID!, $fieldTypeId: ID!, $field: FieldCreateInput!) {
  upsertField(
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    UpsertField(variables: UpsertFieldMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpsertFieldMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpsertFieldMutation>(UpsertFieldDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpsertField', 'mutation');
    },
    DeleteField(variables: DeleteFieldMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteFieldMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteFieldMutation>(DeleteFieldDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteField', 'mutation');
    }
  };
}
