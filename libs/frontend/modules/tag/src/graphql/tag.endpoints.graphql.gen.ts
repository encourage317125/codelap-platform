...
export type GetTagGraphsQuery = { tagGraphs: Array<{ id: string, isRoot: boolean, name: string, descendants: Array<string> }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    CreateTags(variables: CreateTagsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CreateTagsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateTagsMutation>(CreateTagsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateTags', 'mutation');
    },
    UpdateTags(variables: UpdateTagsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpdateTagsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateTagsMutation>(UpdateTagsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateTags', 'mutation');
    },
    DeleteTags(variables: DeleteTagsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteTagsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteTagsMutation>(DeleteTagsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteTags', 'mutation');
    },
    ...
    GetTagGraphs(variables?: GetTagGraphsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetTagGraphsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetTagGraphsQuery>(GetTagGraphsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetTagGraphs', 'query');
    }
  };
}
