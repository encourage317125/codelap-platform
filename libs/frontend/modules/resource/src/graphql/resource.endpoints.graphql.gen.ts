...
export type CreateResourcesMutation = { createResources: { resources: Array<ResourceFragment> } };
...
export type UpdateResourceMutation = { updateResources: { resources: Array<ResourceFragment> } };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetResources(variables?: GetResourcesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetResourcesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetResourcesQuery>(GetResourcesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetResources', 'query');
    },
    CreateResources(variables: CreateResourcesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CreateResourcesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateResourcesMutation>(CreateResourcesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateResources', 'mutation');
    },
    UpdateResource(variables?: UpdateResourceMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpdateResourceMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateResourceMutation>(UpdateResourceDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateResource', 'mutation');
    },
    DeleteResources(variables?: DeleteResourcesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteResourcesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteResourcesMutation>(DeleteResourcesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteResources', 'mutation');
    }
  };
}
