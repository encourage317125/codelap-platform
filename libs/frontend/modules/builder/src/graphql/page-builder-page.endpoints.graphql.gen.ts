...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetPageBuilder(variables: GetPageBuilderQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetPageBuilderQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPageBuilderQuery>(GetPageBuilderDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetPageBuilder', 'query');
    }
  };
}
