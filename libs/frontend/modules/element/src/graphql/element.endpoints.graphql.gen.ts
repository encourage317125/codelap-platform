...
export type CreateElementsMutation = { createElements: { elements: Array<ElementFragment> } };
...
export type UpdateElementsMutation = { updateElements: { elements: Array<ElementFragment> } };
...
export type MoveElementsMutation = { updateElements: { elements: Array<ElementFragment> } };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    DeleteElements(variables: DeleteElementsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteElementsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteElementsMutation>(DeleteElementsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteElements', 'mutation');
    },
    UpdateElements(variables?: UpdateElementsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpdateElementsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateElementsMutation>(UpdateElementsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateElements', 'mutation');
    },
    MoveElements(variables?: MoveElementsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<MoveElementsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<MoveElementsMutation>(MoveElementsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'MoveElements', 'mutation');
    },
