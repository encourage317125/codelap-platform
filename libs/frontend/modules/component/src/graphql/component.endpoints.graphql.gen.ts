...
export type CreateComponentsMutation = { createComponents: { components: Array<ComponentFragment> } };
...
export type UpdateComponentsMutation = { updateComponents: { components: Array<ComponentFragment> } };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    CreateComponents(variables: CreateComponentsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CreateComponentsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateComponentsMutation>(CreateComponentsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateComponents', 'mutation');
    },
    DeleteComponents(variables?: DeleteComponentsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteComponentsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteComponentsMutation>(DeleteComponentsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteComponents', 'mutation');
    },
    UpdateComponents(variables?: UpdateComponentsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpdateComponentsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateComponentsMutation>(UpdateComponentsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateComponents', 'mutation');
    },
    GetComponents(variables?: GetComponentsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetComponentsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetComponentsQuery>(GetComponentsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetComponents', 'query');
    }
  };
}
