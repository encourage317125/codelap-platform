...
import { DomainFragment } from '../../../../../shared/abstract/core/src/domain/domain/domain.fragment.graphql.gen';
import { GraphQLClient } from 'graphql-request';
import * as Dom from 'graphql-request/dist/types.dom';
import { gql } from 'graphql-tag';
import { DomainFragmentDoc } from '../../../../../shared/abstract/core/src/domain/domain/domain.fragment.graphql.gen';
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetDomain(variables?: GetDomainQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetDomainQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetDomainQuery>(GetDomainDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetDomain', 'query');
    },
