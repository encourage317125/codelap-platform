...
export type DeleteCustomActionsMutation = {
  deleteCustomActions: { nodesDeleted: number; relationshipsDeleted: number }
}
...
export type DeleteResourceActionsMutation = {
  deleteResourceActions: { nodesDeleted: number; relationshipsDeleted: number }
}
...
export type DeletePipelineActionsMutation = {
  deletePipelineActions: { nodesDeleted: number; relationshipsDeleted: number }
}
...
export function getSdk(
  ...
  return {
    DeleteCustomActions(
      variables: DeleteCustomActionsMutationVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<DeleteCustomActionsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteCustomActionsMutation>(
            DeleteCustomActionsDocument,
            variables,
    ...
    DeleteResourceActions(
      variables: DeleteResourceActionsMutationVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<DeleteResourceActionsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteResourceActionsMutation>(
            DeleteResourceActionsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'DeleteResourceActions',
    ...
    DeletePipelineActions(
      variables: DeletePipelineActionsMutationVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<DeletePipelineActionsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeletePipelineActionsMutation>(
            DeletePipelineActionsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'DeletePipelineActions',
