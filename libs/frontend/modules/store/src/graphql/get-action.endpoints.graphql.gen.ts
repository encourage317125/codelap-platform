...
export type GetActionsQuery = { customActions: Array<Action_CustomAction_Fragment>, resourceActions: Array<Action_ResourceAction_Fragment>, pipelineActions: Array<Action_PipelineAction_Fragment> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetActions(variables?: GetActionsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetActionsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetActionsQuery>(GetActionsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetActions', 'query');
    }
  };
}
