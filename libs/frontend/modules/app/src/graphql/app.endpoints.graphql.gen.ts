...
export type CreateAppsMutation = { createApps: { apps: Array<AppPreviewFragment> } };
...
export type UpdateAppsMutation = { updateApps: { apps: Array<AppPreviewFragment> } };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    CreateApps(variables: CreateAppsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CreateAppsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateAppsMutation>(CreateAppsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateApps', 'mutation');
    },
    UpdateApps(variables: UpdateAppsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpdateAppsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateAppsMutation>(UpdateAppsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateApps', 'mutation');
    },
    DeleteApps(variables: DeleteAppsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteAppsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteAppsMutation>(DeleteAppsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteApps', 'mutation');
    },
