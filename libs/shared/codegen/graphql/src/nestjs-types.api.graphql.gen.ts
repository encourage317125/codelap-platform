...
export interface AtomWhereUniqueInput {
  id?: Nullable<string>
  type?: Nullable<AtomType>
...
export interface ImportAtomsInput {
  payload: string
}
...
export interface CreateTypeInput {
  ...
  interfaceType?: Nullable<boolean>
  lambdaType?: Nullable<boolean>
  componentType?: Nullable<boolean>
...
export interface IQuery {
  ...
  ): Nullable<ElementGraph> | Promise<Nullable<ElementGraph>>
  getElement(
    input: GetElementInput,
  ): Nullable<Element> | Promise<Nullable<Element>>
  getComponent(
    input: GetComponentInput,
  ): Nullable<Component> | Promise<Nullable<Component>>
  getComponentElements(
    input: GetComponentInput,
  ): Nullable<ElementGraph> | Promise<Nullable<ElementGraph>>
  getComponents(
    input?: Nullable<GetComponentsInput>,
  ): Component[] | Promise<Component[]>
  getAtoms(
    input?: Nullable<GetAtomsInput>,
  ): Nullable<Atom[]> | Promise<Nullable<Atom[]>>
  ...
  getTypeGraph(
    input: GetTypeInput,
  ): Nullable<TypeGraph> | Promise<Nullable<TypeGraph>>
  ...
  getTagGraphs(
    input?: Nullable<GetTagGraphsInput>,
  ): TagGraph | Promise<TagGraph>
}

export interface IMutation {
  upsertUser(input: UpsertUserInput): CreateResponse | Promise<CreateResponse>
  ...
  deletePage(input: DeletePageInput): Nullable<Page> | Promise<Nullable<Page>>
  updatePage(input: UpdatePageInput): Nullable<Void> | Promise<Nullable<Void>>
  createPropMapBinding(
    input: CreatePropMapBindingInput,
  ): CreateResponse | Promise<CreateResponse>
  updatePropMapBinding(
    input: UpdatePropMapBindingInput,
  ): Nullable<Void> | Promise<Nullable<Void>>
  ...
  moveElement(input: MoveElementInput): Nullable<Void> | Promise<Nullable<Void>>
  updateElementProps(
  ...
  createType(input: CreateTypeInput): CreateResponse | Promise<CreateResponse>
  updateEnumType(
  ...
  updateType(input: UpdateTypeInput): Nullable<Void> | Promise<Nullable<Void>>
  deleteType(input: DeleteTypeInput): Nullable<Void> | Promise<Nullable<Void>>
  createField(input: CreateFieldInput): CreateResponse | Promise<CreateResponse>
  updateField(input: UpdateFieldInput): Nullable<Void> | Promise<Nullable<Void>>
  deleteField(input: DeleteFieldInput): Nullable<Void> | Promise<Nullable<Void>>
  createLambda(
  ...
  ): Nullable<LambdaPayload> | Promise<Nullable<LambdaPayload>>
  createTag(input: CreateTagInput): CreateResponse | Promise<CreateResponse>
  updateTag(input: UpdateTagInput): Nullable<Void> | Promise<Nullable<Void>>
  deleteTags(input: DeleteTagsInput): Nullable<Void> | Promise<Nullable<Void>>
  upsertTag(input: UpsertTagInput): Void | Promise<Void>
