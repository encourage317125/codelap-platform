...
export type PropMapBindingFragment = { id: string, sourceKey: string, targetKey: string, element: { id: string, name?: string | null }, targetElement?: { id: string, name?: string | null } | null };
