 ...
 * });
 */
export function useTestGetTypesQuery(
  baseOptions?: Apollo.QueryHookOptions<
    TestGetTypesQuery,
    TestGetTypesQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<TestGetTypesQuery, TestGetTypesQueryVariables>(
    TestGetTypesGql,
    options,
  )
}
export function useTestGetTypesLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<TestGetTypesQuery, TestGetTypesQueryVariables>(
    TestGetTypesGql,
    options,
  )
}
export type TestGetTypesQueryHookResult = ReturnType<
  typeof useTestGetTypesQuery
>
export type TestGetTypesLazyQueryHookResult = ReturnType<
  typeof useTestGetTypesLazyQuery
>
export type TestGetTypesQueryResult = Apollo.QueryResult<
  TestGetTypesQuery,
  TestGetTypesQueryVariables
>
export function refetchTestGetTypesQuery(
  variables?: TestGetTypesQueryVariables,
) {
