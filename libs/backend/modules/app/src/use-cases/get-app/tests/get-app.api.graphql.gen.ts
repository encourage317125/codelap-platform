 ...
 * });
 */
export function useTestGetAppQuery(
  ...
  return Apollo.useQuery<TestGetAppQuery, TestGetAppQueryVariables>(
    TestGetAppGql,
    options,
  )
}
export function useTestGetAppLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<TestGetAppQuery, TestGetAppQueryVariables>(
    TestGetAppGql,
    options,
  )
}
export type TestGetAppQueryHookResult = ReturnType<typeof useTestGetAppQuery>
export type TestGetAppLazyQueryHookResult = ReturnType<
  typeof useTestGetAppLazyQuery
>
export type TestGetAppQueryResult = Apollo.QueryResult<
  TestGetAppQuery,
  TestGetAppQueryVariables
>
