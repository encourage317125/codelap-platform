...
import { RedirectedAppFragment, AppPreviewFragment } from '../../../../../libs/shared/abstract/core/src/domain/app/app.fragment.graphql.gen';
import { GraphQLClient } from 'graphql-request';
import * as Dom from 'graphql-request/dist/types.dom';
import { gql } from 'graphql-tag';
import { RedirectedAppFragmentDoc, AppPreviewFragmentDoc } from '../../../../../libs/shared/abstract/core/src/domain/app/app.fragment.graphql.gen';
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetRedirectedApps(variables?: GetRedirectedAppsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetRedirectedAppsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRedirectedAppsQuery>(GetRedirectedAppsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetRedirectedApps', 'query');
    },
