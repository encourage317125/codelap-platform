...
import { AtomType, PrimitiveKind } from '@codelab/shared/abstract/core'
import { TypeEdgeKind, TypeKind } from '@codelab/shared/codegen/graphql'
...
const string: TypeFragment = {
  ...
  name: PrimitiveKind.String.toString(),
...
const float: TypeFragment = {
  id: v4(),
  __typename: 'PrimitiveType',
  name: PrimitiveKind.Float.toString(),
  typeKind: TypeKind.PrimitiveType,
...
const bool: TypeFragment = {
  id: v4(),
  __typename: 'PrimitiveType',
  name: PrimitiveKind.Boolean.toString(),
  typeKind: TypeKind.PrimitiveType,
