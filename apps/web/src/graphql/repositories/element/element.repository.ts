...
import { Component, Element as ElementModel } from '../../model'
import { Element, ElementGraph } from '../../ogm-types.gen'
    ...
    elementRepository
      ...
      .pipe(
        mergeMap(({ edges }) => {
          ...
          // load vertices
          const verticesPromise = ElementModel().then((_ElementModel) =>
            _ElementModel.find({
      ...
      .pipe(
        mergeMap(([edges, vertices]) => {
          ...
          const graph = { vertices, edges } as ElementGraph
