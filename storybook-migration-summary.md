...
- `npx storybook@latest automigrate --config-dir apps/platform/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir libs/frontend/domain/app/.storybook --renderer undefined`
